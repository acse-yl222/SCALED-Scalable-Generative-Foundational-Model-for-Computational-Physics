...
class ResnetBlock3D(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.conv1 = nn.Conv3d(in_channels, out_channels, kernel_size=3, stride=1, padding=1,padding_mode='replicate')
        ...
        self.conv2 = nn.Conv3d(out_channels, conv_3d_out_channels, kernel_size=3, stride=1, padding=1,padding_mode='replicate')
