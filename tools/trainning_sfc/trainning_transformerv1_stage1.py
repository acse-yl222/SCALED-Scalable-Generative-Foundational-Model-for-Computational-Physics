...
def main(cfg):
    ...
    denoising_unet  = DiTTransformer1DModel(in_channels=2,out_channels=2,sample_size=20560,patch_size=4,num_layers=16,attention_head_dim=48)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="./config/SCALED_sfc/trainning_transformerv1_stage1.yaml")
